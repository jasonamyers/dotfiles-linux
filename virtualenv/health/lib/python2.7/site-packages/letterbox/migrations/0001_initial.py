...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Notice'
        db.create_table('letterbox_notice', (
        ...
        db.send_create_signal('letterbox', ['Notice'])


    def backwards(self, orm):
        
        # Deleting model 'Notice'
        db.delete_table('letterbox_notice')
    ...
    models = {
        ...
        'letterbox.notice': {
            'Meta': {'ordering': "['-created_ts']", 'object_name': 'Notice'},
